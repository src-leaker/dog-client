 ...
 */
    public boolean initialize( URL url )
    {
        ...
        if( urlConnection != null )
        {
            try
            {
                inputStream = openInputStream(); // implementation of added openInputStream method.
            }
            catch( IOException ioe )
            {
...
/**
 * "Augmented" method overridden in the MC CodecMus class.
 * Not part of the base SoundSystem library.
 */
